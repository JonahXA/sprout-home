...
export default function MLTrainingSimulator({ onComplete }) {
 ...
 <Camera className="w-16 h-16 mx-auto text-[#1B2B5E] mb-4" />
 ...
 className="h-14 bg-[#E8F0FE]0 hover:bg-[#1B2B5E] text-sm"
 >
 Quick Add
 </Button>
 <Button
 onClick={() => setShowImageUpload("dogs")}
 className="h-14 bg-[#1B2B5E] hover:bg-blue-700 text-sm"
 >
 Upload Image
 </Button>
 </div>
 ...
 <div className="bg-[#E8F0FE] p-4 rounded-lg border-2 border-blue-300">
 <input
 type="file"
 accept="image/*"
 multiple
 ...
 className="w-full h-14 bg-[#1B2B5E] hover:bg-purple-700 disabled:opacity-50"
 >
 {modelTrained
 ? "Training..."
 ...
 <div className="bg-[#E8F0FE] p-6 rounded-lg space-y-3">
 ...
 <>
 <AlertCircle className="w-16 h-16 mx-auto text-[#1B2B5E] mb-4" />
 ...
 <div className="bg-[#E8F0FE] p-4 rounded-lg border-l-4 border-[#1B2B5E]">
 ...
 <Button onClick={() => onComplete && onComplete()} className="w-full h-14 bg-[#1B2B5E] hover:bg-purple-700">
