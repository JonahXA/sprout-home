...
import EthicsScenarios from "@/features/ai-literacy/EthicsScenarios";
...
export default function AIDay6() {
 ...
 <h4 className="font-bold text-[#1B2B5E] flex items-center gap-2">
 ...
 <Scale className="w-6 h-6 text-[#1B2B5E]" />
