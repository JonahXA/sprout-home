...
export default function Account() {
 ...
 <div className="p-4 rounded-xl bg-[#E8F0FE] border border-[#1B2B5E]/20">
 ...
 <div className="p-4 rounded-xl bg-[#F3F0FF] border border-[#7C3AED]/20">
 <p className="text-sm text-gray-600 mb-1">Current Streak</p>
 <p className="text-3xl font-bold text-purple-600">{user.current_streak || 0} days</p>
 </div>
 <div className="p-4 rounded-xl bg-[#FFF0E6] border border-[#F97316]/20">
