...
export default function Learn() {
 ...
 style={{ borderRadius:16, border:`1px solid ${C.border}`, boxShadow:"0 1px 4px rgba(0,0,0,0.05)", background:C.bg, cursor:"pointer", overflow:"hidden", transition:"all 0.2s", display:"flex", flexDirection:"column" }}
 ...
 {/* Body — flex column so button always pins to bottom */}
 ...
 <button style={{ width:"100%", height:38, borderRadius:999, background:C.navy, color:"#fff", fontSize:12, fontWeight:700, border:"none", cursor:"pointer", flexShrink:0 }}
 onMouseEnter={e => e.currentTarget.style.background = C.navyMid}
 onMouseLeave={e => e.currentTarget.style.background = C.navy}
 >{user ? "Start Learning" : "Sign in to Start"}</button>
 )}
 </div>
 </div>
 );
