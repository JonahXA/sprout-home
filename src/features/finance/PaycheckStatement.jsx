...
export default function PaycheckStatement() {
 ...
 tip: "Location Matters: Your take-home pay can vary significantly depending on where you live."
 },
 {
 id: "social",
 ...
 <Badge className="bg-[#E8F0FE] text-[#1B2B5E]">Understanding Paychecks</Badge>
 </div>
 <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
 <motion.div
 className="h-full bg-[#1B2B5E]"
 initial={{ width: 0 }}
 ...
 <DollarSign className="w-8 h-8 text-[#1B2B5E]" />
 ...
 <div>
 <div className="text-[#1B2B5E] font-bold text-xl mb-1">SPROUT COMPANY</div>
 ...
 <div className={`grid grid-cols-4 gap-2 text-xs transition-all duration-300 ${currentStepData.highlight === 'gross' ? 'bg-[#E8F0FE] border-2 border-[#1B2B5E] rounded p-2 scale-105' : 'py-1'}`}>
 <div>Regular Pay</div>
 <div className="text-right">$20.00</div>
 <div className="text-right">80</div>
 <div className="text-right font-bold">$1,600.00</div>
 </div>
 <div className={`mt-2 pt-2 border-t flex justify-between font-bold transition-all duration-300 ${currentStepData.highlight === 'gross' ? 'bg-[#E8F0FE] p-2 rounded text-base' : ''}`}>
 <div>GROSS PAY</div>
 ...
 {/* Deductions Section */}
 <div className={`mb-4 transition-all duration-300 ${currentStepData.highlight === 'federal' || currentStepData.highlight === 'state' || currentStepData.highlight === 'social' || currentStepData.highlight === 'medicare' || currentStepData.highlight === 'other' ? 'border-2 border-[#1B2B5E] rounded-lg p-2' : ''}`}>
 ...
 <div className={`flex justify-between transition-all duration-300 ${currentStepData.highlight === 'federal' ? 'bg-[#E8F0FE] border-2 border-[#1B2B5E] rounded p-2 scale-105 font-bold' : 'py-1'}`}>
 <div>Federal Income Tax</div>
 <div className="text-red-600">-$192.00</div>
 </div>
 <div className={`flex justify-between transition-all duration-300 ${currentStepData.highlight === 'state' ? 'bg-[#E8F0FE] border-2 border-[#1B2B5E] rounded p-2 scale-105 font-bold' : 'py-1'}`}>
 <div>State Income Tax</div>
 <div className="text-red-600">-$80.00</div>
 </div>
 <div className={`flex justify-between transition-all duration-300 ${currentStepData.highlight === 'social' ? 'bg-[#E8F0FE] border-2 border-[#1B2B5E] rounded p-2 scale-105 font-bold' : 'py-1'}`}>
 <div>Social Security Tax (6.2%)</div>
 <div className="text-red-600">-$99.20</div>
 </div>
 <div className={`flex justify-between transition-all duration-300 ${currentStepData.highlight === 'medicare' ? 'bg-[#E8F0FE] border-2 border-[#1B2B5E] rounded p-2 scale-105 font-bold' : 'py-1'}`}>
 <div>Medicare Tax (1.45%)</div>
 <div className="text-red-600">-$23.20</div>
 </div>

 <div className={`font-bold border-b pb-1 mb-2 mt-3 transition-all duration-300 ${currentStepData.highlight === 'other' ? 'bg-[#E8F0FE]' : ''}`}>Other Deductions</div>
 <div className={`flex justify-between transition-all duration-300 ${currentStepData.highlight === 'other' ? 'bg-[#E8F0FE] border-2 border-[#1B2B5E] rounded p-2 scale-105 font-bold' : 'py-1'}`}>
 ...
 {/* Net Pay Section */}
 <div className={`bg-[#E8F0FE] border-2 border-[#1B2B5E] rounded-lg p-4 transition-all duration-300 ${currentStepData.highlight === 'net' ? 'scale-105 shadow-xl border-[#1B2B5E]' : ''}`}>
 <div className="flex justify-between items-center">
 <div>
 <div className="text-xs text-gray-600 mb-1">NET PAY (Take-Home)</div>
 <div className="text-3xl font-bold text-[#1B2B5E]">$1,065.60</div>
 </div>
 ...
 <div className="font-bold text-[#1B2B5E]">SPROUT COMPANY</div>
 ...
 <span className="text-2xl font-bold text-[#1B2B5E]">$1,065.60</span>
 </div>
 </div>
 ...
 {/* Explanation */}
 <div className="bg-[#E8F0FE] border-l-4 border-[#1B2B5E] p-6 rounded-lg mb-4">
 <p className="text-gray-800 whitespace-pre-line leading-relaxed">{currentStepData.content}</p>
 </div>

 {/* Tip */}
 <div className="bg-[#E6F5EF] border-l-4 border-[#2D9B6F] p-4 rounded-lg">
